...
<main class="u-flex-1">
  <section class="hero">
    <div class="hero-content">
      ...
      <p>
        Experimentá medicina veterinaria de vanguardia brindada con calidez
        genuina. Combinamos precisión clínica con tranquilidad emocional.
      </p>
    ...
    <div class="container">
      ...
      <div class="services-grid">
        <div class="service-card big">
          ...
          <a href="booking.php" class="btn btn-light btn-sm">Reservar Consulta</a>
        </div>
  ...
  <section class="why-us">
    <div class="container why-grid">
      <div class="why-text">
        ...
        <p>
          Diseñamos nuestra clínica para minimizar el estrés. Desde técnicas
          de manejo sin miedo hasta nuestro entorno especializado y relajante,
          priorizamos el bienestar emocional junto con la excelencia clínica.
        </p>
        <ul class="check-list">
